...
public class type36Activity extends Activity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.type36_layout);
        ...
        logout.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				Intent i = new Intent(type36Activity.this, MainActivity.class);
            	startActivity(i);
            	finish();
			}
		});
        ...
        back.setOnClickListener(new View.OnClickListener() {
			...
			@Override
			public void onClick(View arg0) {
				Intent i = new Intent(type36Activity.this, MyListActivity.class);
				Intent in = getIntent();
