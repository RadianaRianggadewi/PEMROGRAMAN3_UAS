...
public class UserDataSource {
	...
	private String[] allColumns = { 
									...
									MySQLiteHelper.COLUMN_NAMA, 
									MySQLiteHelper.COLUMN_KTP, 
									MySQLiteHelper.COLUMN_ALAMAT, 
									MySQLiteHelper.COLUMN_HP, 
	...
	public void deleteData(String name) {
		database.delete(dbHelper.TABLE_USERS, dbHelper.COLUMN_USER + "=?", new String[]{name}); 
	}
	
	public String getSinlgeEntry(String userName) {
		Cursor cursor=database.query(dbHelper.TABLE_USERS, null, dbHelper.TABLE_USERS+"=?", new String[]{userName}, null,
				null, null, null);
	...
	public Cursor getData(String userName) {
		Cursor cursor=database.query(dbHelper.TABLE_USERS, null, dbHelper.COLUMN_USER+"=?", new String[]{userName}, null,
				null, null, null);
	...
	public Cursor readEntry() {
		...
		Cursor c = database.query(MySQLiteHelper.TABLE_USERS, allColumns, null, null, null, null, null);
		if (c != null) {
			c.moveToFirst();
		}
		return c;
