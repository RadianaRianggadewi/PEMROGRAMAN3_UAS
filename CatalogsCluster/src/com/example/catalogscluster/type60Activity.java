...
public class type60Activity extends Activity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.type60_layout);
        ...
        logout.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				Intent i = new Intent(type60Activity.this, MainActivity.class);
            	startActivity(i);
            	finish();
			}
        ...
        back.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				Intent i = new Intent(type60Activity.this, MyListActivity.class);
				Intent in = getIntent();
